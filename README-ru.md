...
### Frontend
- **Next.js** - фреймворк приложения и система маршрутизации
...
- **color-hash** - детерминированная генерация цветов
- **tinycolor2** - инструменты для работы с цветами
- **Tippy.js** - всплывающие подсказки и интерактивные элементы
